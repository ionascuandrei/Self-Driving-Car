...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "C_AXI4_Lite_BASEADDR" -parent ${Page_0}
  ipgui::add_param $IPINST -name "C_AXI4_Lite_HIGHADDR" -parent ${Page_0}
...
proc update_PARAM_VALUE.C_AXI4_Lite_BASEADDR { PARAM_VALUE.C_AXI4_Lite_BASEADDR } {
	# Procedure called to update C_AXI4_Lite_BASEADDR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_AXI4_Lite_BASEADDR { PARAM_VALUE.C_AXI4_Lite_BASEADDR } {
	# Procedure called to validate C_AXI4_Lite_BASEADDR
	return true
}

proc update_PARAM_VALUE.C_AXI4_Lite_HIGHADDR { PARAM_VALUE.C_AXI4_Lite_HIGHADDR } {
	# Procedure called to update C_AXI4_Lite_HIGHADDR when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.C_AXI4_Lite_HIGHADDR { PARAM_VALUE.C_AXI4_Lite_HIGHADDR } {
	# Procedure called to validate C_AXI4_Lite_HIGHADDR
	return true
}
